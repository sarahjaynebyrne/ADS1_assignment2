...
""" Experimenting with Predictive Modelling of CO2 Emissions """
...
# plotting
ax6[0,0].plot(sa_for_df['Year'],
              sa_for_df['Argentina'],
              color = 'purple')
ax6[0,1].plot(sa_for_df2['Year'],
              sa_for_df2['Argentina'], 
              color = 'pink')
ax6[1,0].plot(sa_for_df3['Year'],
              sa_for_df3['Argentina'], 
              color = 'green')
ax6[1,1].plot(sa_for_df4['Year'],
              sa_for_df4['Argentina'], 
              color = 'orange')

ax6[0,0].set_ylabel('Forest Area')
ax6[1,0].set_ylabel('Forest Area')

# rotating the x axis
ax6[1,0].tick_params(axis = 'x',
                labelrotation = 90)
ax6[1,1].tick_params(axis = 'x',
                     labelrotation = 90)

# set titles 
ax6[0,0].set_title('Original Data')
ax6[0,1].set_title('Linear Interpolation')
ax6[1,0].set_title('K-Nearest Neighbour Interpolation')
ax6[1,1].set_title('Cubic Interpolation')
